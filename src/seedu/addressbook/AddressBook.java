...
public class AddressBook {
    ...
    */
    ...
    private static Optional<HashMap<String, String>> decodePersonFromString(String encoded) {
        ...
        final HashMap<String, String> decodedPerson = new HashMap<String, String>();
        decodedPerson.put(PERSON_PROPERTY_NAME, extractNameFromPersonString(encoded));
        decodedPerson.put(PERSON_PROPERTY_PHONE, extractPhoneFromPersonString(encoded));
        decodedPerson.put(PERSON_PROPERTY_EMAIL, extractEmailFromPersonString((encoded)));
